...
namespace tainicom.Aether.Physics2D
{
    public static class Settings
    {
        ...
        /// chosen to be numerically significant, but visually insignificant.
        /// </summary>
        public static float AngularSlop = (2.0f / 180.0f * MathHelper.Pi);
        ...
        /// prevent overshoot.
        /// </summary>
        public static float MaxAngularCorrection = (8.0f / 180.0f * MathHelper.Pi);
        ...
        /// to overshoot.
        /// </summary>
        public static float BaumgarteTOI = 0.75f;
        ...
        /// </summary>
        public static float AngularSleepTolerance = (2.0f / 180.0f * MathHelper.Pi);
        ...
        public static float MaxTranslation {
            ...
            set {
                ...
                MaxTranslationSquared = _maxTranslation * _maxTranslation;
            }
        }
        private static float _maxTranslation = 2.0f;

        public static float MaxTranslationSquared = (_maxTranslation * _maxTranslation);
        ...
        public static float MaxRotation { 
            ...
            set { 
                _maxRotation = value;
                MaxRotationSquared = _maxRotation * _maxRotation;
            } }
        private static float _maxRotation = (0.5f * MathHelper.Pi);

        public static float MaxRotationSquared = (_maxRotation * _maxRotation);
        ...
        {
            //return (float)(friction1 * friction1);
